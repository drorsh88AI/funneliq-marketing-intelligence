...
> **הבהרת 10A/CP7 — 12.09.2026:** הפאזה סגורה והחוזה החיצוני נשאר יציב.
> התיקונים המתוכננים ב־CP9 מחליפים את מודל P4S, את אוכלוסיית
> `calls_to_closed` ואת ארטיפקט P6 בלי להוסיף endpoint או שדה תגובה. אם
> יידרש שינוי OpenAPI, עוצרים לביקורת במקום להרחיב את החוזה בשקט.
...
הערכים הנצפים. מ־10A/CP9 יתר הפיצ'רים מוצבים מפרופיל רב־משתני תקף שנצפה
ב־train; המימוש החציוני הפעיל חסום. השדה נשאר לאחידות ומתועד כמצב
לא־נגיש, **לא כמצב מת**.

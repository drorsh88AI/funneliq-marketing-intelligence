...
> **הבהרת 10A/CP7 — 12.09.2026:** הפאזה נסגרה ומוזגה ל־`main`; פסקת המעמד
> הישנה שלהלן היא תצלום זמן מלפני הסגירה. Logistic נבחר ונפרס לפי הכלל
> שאושר אז, אך הכרעת המשתמש המאוחרת קובעת CatBoost שאומן על יעד P4S כמודל
> הראשי. ההחלפה בוצעה ב־10A/CP9 תוך שמירת ארבעת הקלטים והחוזה החיצוני;
> המדדים החדשים מתועדים ב־`models/metrics.json` וביומן 10A.

**מעמד היסטורי לפני הסגירה:** ההכרעות D1–D21 נסגרו לאחר שישה סבבי אפיון מול Codex (08–09.09.2026),
